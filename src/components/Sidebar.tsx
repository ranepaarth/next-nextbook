...
async function Sidebar() {
  ...
  return (
    <aside className='flex w-fit max-w-[600px] flex-col space-y-4 sm:w-3/12 sm:min-w-[150px] '>
      <div className='flex flex-col space-y-2 rounded-lg p-2 sm:bg-white'>
        {session?.user ? (
        ...
        <a href='https://github.com/ranepaarth/next-nextbook' target='_blank'>
          <SideBarRow Icon={CodeBracketIcon} title={'Source code'} />
        </a>
